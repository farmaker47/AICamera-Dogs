...
Java_com_soloupis_aiflowers_MainActivity_initCaffe2(JNIEnv *env, jobject /* this */, jobject assetManager) {

    AAssetManager *mgr = AAssetManager_fromJava(env, assetManager);
    alog("Attempting to load protobuf netdefs...");
    loadToNetDef(mgr, &_initNet,   "soloupis_init_net.pb");
    loadToNetDef(mgr, &_predictNet,"soloupis_predict_net.pb");
    alog("done.");
...
Java_com_soloupis_aiflowers_MainActivity_predFromCaffe2(
        JNIEnv *env,
        jobject /* this */,
